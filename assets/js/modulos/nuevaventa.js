var nuevaventa = (function(window, document){
    var metodos = {
        ...
        buscarCliente: function(dni){
            ...
            var ajaxUrl = base_url+'/cliente/buscarCliente?dni='+dni+'&request';
        ...
        mostrarAgregados: function(){
            ...
            for(let i = 0; i < this.list_agregados.length; i++){
                html = html + `<tr class="odd gradeX">
                        ...
                        <td class="text-center">
                            <button class="btn btn-secondary btn-small btn-sm" onclick="nuevaventa.quitarProducto(${i})"><i class="fa fa-times"></i></button>
                        </td>
                    </tr>`;
