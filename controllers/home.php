...
class Home extends Controller {
	...
	public function render(){
		...
		$this->view->data['almacens'] = $this->model->getCountAlmacen();
		$this->view->data['categorias'] = $this->model->getCountCategorias();
		$this->view->data['proveedores'] = $this->model->getCountProveedores();
