...
class Producto extends Controller{
	...
	public function nuevoRegistro(){
		if(isset($_POST['nombre']) && isset($_POST['stock']) && isset($_POST['precio']) && isset($_POST['idcategoria']) && isset($_POST['idalmacen'])  && isset($_POST['precio_compra'])){
	...
	public function editarRegistro(){
		if(isset($_POST['idproducto']) && isset($_POST['nombre']) && isset($_POST['stock']) && isset($_POST['precio']) && isset($_POST['idcategoria'])  && isset($_POST['idalmacen']) && isset($_POST['precio_compra'])){
			if(!empty($_FILES['imagen']['tmp_name'])){
				$foto=file_get_contents($_FILES['imagen']['tmp_name']);	
			}else{
				$foto = null;	
