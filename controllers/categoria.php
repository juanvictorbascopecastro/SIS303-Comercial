...
class Categoria extends Controller {
    ...
    public function nuevoRegistro(){
        if(isset($_POST['nombre'])){
            ...
            $color = $_POST['color'];
            $res = $this->model->insert(['nombre' => $nombre, 'descripcion' => $descripcion, 'color' => $color]);
            if($res){
    ...
    public function editarRegistro(){
        if(isset($_POST['nombre']) && isset($_POST['idcategoria'])){
            ...
            $color = $_POST['color'];
            $res = $this->model->edit(['nombre' => $nombre, 'descripcion' => $descripcion, 'idcategoria' => $idcategoria, 'color' => $color]);
            if($res){
