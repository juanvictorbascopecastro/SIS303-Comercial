        ...
        *********************************************************************************************************************************************************** -->
        ...
        <section id="main-content">
            <section class="wrapper">
                <div class="row">
                    <div class="col-md-6">
                        <h3><i class="fa fa-truck"></i> PEDIDOS</h3>
                    </div>
                    <div class="col-md-6 text-right mt-5">
                        <a type="button" class="btn btn-primary" href="<?php BASE_URL;?>pedidos/nuevopedido">Hacer Pedido</a>
                    </div>
                </div>		
                <div class="row mt-0">
                    <div class="col-lg-12">
                ...
                <div class="row">
                    <?php require './views/pedidos/detalles.php' ?>
                </div>
            </section>
        </section>
